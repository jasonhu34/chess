...
class TestMoves(unittest.TestCase):
    ...
    def test_initial_board(self):
        ...
        bishop_moves = board.get_space(0,1).possible_moves
        knight_moves = board.get_space(0,2).possible_moves
        ...
        self.assertEqual(knight_moves,{(2,1):'-',(2,3):'-'},"Incorrect moves")
    ...
    def test_moves_Kasparov_vs_Topalov(self):
        ...
        self.assertEqual(white_pieces[1].possible_moves,{(6,0):'-',(7,0):'-'},"White king incorrect moves")
        ...
        self.assertEqual(black_pieces[0].possible_moves,{(3,2):'-',(2,2):'-',(1,2):'-',(0,2):'-',(3,3):'-',(2,4):'-',(4,1):'-',(4,0):'-',(4,3):'-',(4,4):'-',(4,5):'-',(4,6):'-',(4,7):'-',(5,1):'-',(6,0):'-',(5,2):'-',(6,2):'-',(7,2):'-',(5,3):'-',(6,4):'-',(7,5):white_pieces[4]},"Black Queen incorrect moves")
        self.assertEqual(black_pieces[1].possible_moves,{(6,4):'-',(7,4):'-'},"Black king incorrect moves")
